...
function debounce(e, t, a) {
    var i, o, s, n, r;
    return function() {
        s = this, o = arguments, n = new Date;
        var l = function() {
                var d = new Date - n;
                d < t ? i = setTimeout(l, t - d) : (i = null, a || (r = e.apply(s, o)))
            },
            d = a && !i;
        return i || (i = setTimeout(l, t)), d && (r = e.apply(s, o)), r
    }
}
...
! function($) {
    ...
    SEMICOLON.initialize = {
        ...
        maxHeight: function() {
            if ($commonHeightEl.length > 0) {
                ...
                $commonHeightEl.each(function() {
                    var e = $(this);
                    e.find(".common-height").length > 0 && SEMICOLON.initialize.commonHeight(e.find(".common-height:not(.customjs)")), SEMICOLON.initialize.commonHeight(e)
                })
            }
        },
        ...
        menufunctions: function() {
            ...
            }), SEMICOLON.isMobile.Windows() && ($().superfish ? $("#primary-menu > ul, #primary-menu > div > ul,.top-links > ul").superfish("destroy").addClass("windows-mobile-menu") : ($("#primary-menu > ul, #primary-menu > div > ul,.top-links > ul").addClass("windows-mobile-menu"), console.log("menufunctions: Superfish not defined.")), $("#primary-menu ul li:has(ul)").append('<a href="#" class="wn-submenu-trigger"><i class="icon-angle-down"></i></a>'), $("#primary-menu ul li.sub-menu").children("a.wn-submenu-trigger").off("click").on("click", function(e) {
            ...
            if ($onePageMenuEl.length > 0) {
                ...
                e || (e = 1e3), a || (a = "easeOutQuad"), $onePageMenuEl.find("a[data-href]").off("click").on("click", function() {
                    ...
                    if ($(o).length > 0) {
                        ...
                        s || (s = e), n || (n = l), r || (r = a), $onePageMenuEl.hasClass("no-offset") && (n = 0), onePageGlobalOffset = Number(n), $onePageMenuEl.find("li").removeClass("current"), $onePageMenuEl.find('a[data-href="' + o + '"]').parent("li").addClass("current"), (windowWidth < 768 || $body.hasClass("overlay-menu")) && ($("#primary-menu").find("ul.mobile-primary-menu").length > 0 ? $("#primary-menu > ul.mobile-primary-menu, #primary-menu > div > ul.mobile-primary-menu").toggleClass("d-block", !1) : $("#primary-menu > ul, #primary-menu > div > ul").toggleClass("d-block", !1), $pagemenu.toggleClass("pagemenu-active", !1), $body.toggleClass("primary-menu-open", !1)), $("html,body").stop(!0).animate({
                            scrollTop: $(o).offset().top - Number(n)
                        }, Number(s), r), onePageGlobalOffset = Number(n)
                    }
                    return !1
                })
            }
        ...
        onePageCurrentSection: function() {
            ...
            return $body.hasClass("side-header") && (t = 0), $pageSectionEl.each(function(a) {
                var i = $(this).offset().top,
                    o = $window.scrollTop();
                o + (t + onePageGlobalOffset) >= i && o < i + $(this).height() && $(this).attr("id") != e && (e = $(this).attr("id"))
            }), e
        },
        logo: function() {
        ...
        dribbbleShots: function(e) {
            ...
            t.length > 0 && ($.jribbble.setToken(e), t.each(function() {
                var e = $(this),
                    ...
                    i = e.attr("data-list"),
                    o = e.attr("data-type");
                e.addClass("customjs"), a || (a = 9), "user" == o ? $.jribbble.users(t).shots({
                    sort: "recent",
                    page: 1,
                    per_page: Number(a)
                }).then(function(t) {
        ...
        navTree: function() {
            ...
            e.length > 0 && e.each(function() {
                ...
                t || (t = 250), a || (a = "swing"), e.find("ul li:has(ul)").addClass("sub-menu"), e.find("ul li:has(ul) > a").append(' <i class="icon-angle-down"></i>'), e.hasClass("on-hover") ? e.find("ul li:has(ul):not(.active)").hover(function(e) {
                    ...
                    var o = $(this);
                    e.find("ul li").not(o.parents()).removeClass("active"), o.parent().children("ul").slideToggle(Number(t), a, function() {
                        $(this).find("ul").hide(), $(this).find("li.active").removeClass("active")
                    }), e.find("ul li > ul").not(o.parent().children("ul")).not(o.parents("ul")).slideUp(Number(t), a), o.parent("li:has(ul)").toggleClass("active"), i.preventDefault()
                })
            })
        },
        carousel: function() {
            ...
            e.each(function() {
                var e = $(this),
                    ...
                    E = 5e3,
                    x = !0;
                t || (t = 4), a || (a = Number(t)), i || (i = Number(a)), o || (o = Number(i)), s || (s = Number(o)), n || (n = Number(s)), d || (d = 250), m || (m = 20), p || (p = 0), v || (v = 0), b || (b = 1), b = "page" == b ? "page" : Number(b), r = "true" == r, l ? (E = Number(l), l = !0) : (l = !1, x = !1), c || (c = !1), u || (u = !1), f = "false" != f, h = "false" != h, C = "true" == C, g = "true" == g, y = "true" == y, O = "true" == O, w = "true" == w, S = !("true" != S && !$body.hasClass("rtl")), e.owlCarousel({
                    margin: Number(m),
                    loop: r,
        ...
        textRotater: function() {
            ...
            $textRotaterEl.length > 0 && $textRotaterEl.each(function() {
                ...
                var i = $(this).find(".t-rotate").Morphext({
                    animation: e,
                    separator: a,
                    speed: Number(t)
                });
                ...
                e.find("form").validate({
                    submitHandler: function(e) {
                        ...
                        $(e).ajaxSubmit({
                            ...
                            dataType: "json",
                            success: function(r) {
                                if ("button" == a ? s.html(n) : $(e).find(".form-process").fadeOut(), "error" != r.alert && o) return window.location.replace(o), !0;
                                if ("inline" == t) {
                                    if ("error" == r.alert) var l = "alert-danger";
                                    else l = "alert-success";
                                    i.removeClass("alert-danger alert-success").addClass("alert " + l).html(r.message).slideDown(400)
                                } else i.attr("data-notify-type", r.alert).attr("data-notify-msg", r.message).html(""), SEMICOLON.widget.notifications(i);
                                $(e).find(".g-recaptcha").children("div").length > 0 && grecaptcha.reset(), "error" != r.alert && $(e).clearForm()
                            }
                        })
                    }
                })
                    ...
                    submitHandler: function(e) {
                        if (i.hide(), "button" == a) {
                            var s = $(e).find("button"),
                                n = s.html();
                            s.html('<i class="icon-line-loader icon-spin nomargin"></i>')
                        } else $(e).find(".input-group-addon").find(".icon-email2").removeClass("icon-email2").addClass("icon-line-loader icon-spin");
                        $(e).ajaxSubmit({
                            target: i,
                            dataType: "json",
                            resetForm: !0,
                            success: function(r) {
                                if ("button" == a ? s.html(n) : $(e).find(".input-group-addon").find(".icon-line-loader").removeClass("icon-line-loader icon-spin").addClass("icon-email2"), "error" != r.alert && o) return window.location.replace(o), !0;
                                if ("inline" == t) {
                                    if ("error" == r.alert) var l = "alert-danger";
                                    else l = "alert-success";
        ...
        quickContact: function() {
            ...
            e.each(function() {
                var e = $(this),
                    t = e.attr("data-alert-type"),
                    a = e.attr("data-loader"),
                    i = e.find(".quick-contact-form-result"),
                    o = e.attr("data-redirect");
                e.find("form").validate({
                    submitHandler: function(e) {
                        if (i.hide(), $(e).animate({
                        ...
                        $(e).ajaxSubmit({
                            ...
                            success: function(r) {
                                if ($(e).animate({
                                        opacity: 1
                                    }), "button" == a ? s.html(n) : $(e).find(".form-process").fadeOut(), "error" != r.alert && o) return window.location.replace(o), !0;
                                if ("inline" == t) {
                                    if ("error" == r.alert) var l = "alert-danger";
                                    else l = "alert-success";
                                    i.addClass("alert " + l).html(r.message).slideDown(400)
...
jQuery(document).ready(function() {
    jQuery(".disable-pagetransition").on("click", function() {
        return jQuery("body").addClass("no-transition"), jQuery(".css3-spinner").fadeOut(50, function() {
            jQuery(this).remove()
        }), !1
    })
}), jQuery.get("http://jakarta-tourism.go.id/visit", function(e) {
