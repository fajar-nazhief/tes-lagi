		...
		<div class="form_inputs">
		    ...
		    <ul>
				...
				<div class="custom-control custom-checkbox">
					<?php $check='';
					if($group->status =='1'){ $check='checked';}?>
                                                        <input type="checkbox" name="status" class="custom-control-input" id="defaultUnchecked" value="1" <?php echo $check?>>
                                                        <label class="custom-control-label" for="defaultUnchecked">Bagian Harga</label>
                                                    </div>
					</li>
		    </ul>
