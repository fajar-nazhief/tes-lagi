...
<div id="panel-4" class="panel">
	<div class="panel-hdr">
									...
									<button type="submit" class="btn btn-primary btn-icon waves-effect waves-themed">
													...
													<a data-toggle="tooltip" title="Reset Search" href="<?php echo base_url()?>admin/master_barang/reset" class="btn btn-default btn-icon waves-effect waves-themed" >
...
<?php if ($masters): ?>
    ...
    <table class="table table-bordered table-striped m-0" cellspacing="0">
		...
		<?php foreach ($masters as $master):?>
			<tr>
				<td><?php echo $master->master_name ?></td>
				<td class="actions text-center">
			 <?php if ( ! in_array($master->master_name, array('user', 'admin'))): ?>
					<a href="<?php echo base_url().'admin/master/delete/'.$master->id?>" class="btn btn-sm btn-icon btn-outline-danger rounded-circle mr-1" title="Delete Record" onclick="return confirm('Do you want to delete this data? ')">
						 ...
						 <div class="dropdown d-inline-block">
							<a href="<?php echo base_url().'admin/master/edit/'.$master->id?>"   class="btn btn-sm btn-icon btn-outline-primary rounded-circle shadow-0"  aria-expanded="true" title="More options" >
