...
class My_m extends MY_Model {
	...
	function get_all()
	{   
		$this->db->select($this->_table.'.*, '.$this->_table.'_categories.title AS category_title, '.$this->_table.'_categories.slug AS category_slug');
		$this->db->join($this->_table.'_categories', $this->_table.'.category_id = '.$this->_table.'_categories.id', 'left');
