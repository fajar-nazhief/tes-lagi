<ul class="primary-nav">
	...
	<li id="dashboard-link"><?php echo anchor('admin', lang('global:dashboard'), 'class="top-link '.( ! $this->module ? 'current ' : '').'"') ?></li>
		...
		foreach ($menu_items as $key => $menu_item)
		{
			...
			{
				echo '<li><a href="'.current_url().'#" class="top-link" style="font-size:12px">'.lang_label($key).'</a><ul>';
			...
			{
				echo '<li><a href="'.site_url($menu_item).'" class="top-link no-submenu" style="font-size:12px">'.lang_label($key).'</a></li>';
			}
